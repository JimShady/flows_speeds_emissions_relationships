...
## Model result
* `r toupper(sources[1])` adjusted R-squared: `r summary(models[[1]])$adj.r.squared`
* `r toupper(sources[2])` adjusted R-squared: `r summary(models[[2]])$adj.r.squared`
* `r toupper(sources[3])` adjusted R-squared: `r summary(models[[3]])$adj.r.squared` 
* `r toupper(sources[4])` adjusted R-squared: `r summary(models[[4]])$adj.r.squared`
